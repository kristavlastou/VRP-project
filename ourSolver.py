...
class Solver:
    ...
    def LocalSearch(self, operator):
        ...
        while terminationCondition is False:
            operator = random.randint(0,2) #we could also wright localSearchIterator
            ...
            if operator == 0:
                ...
                if rm.originRoutePosition is not None:
                    if rm.moveCost_penalized < 0: #if rm.moveCost < 0:
            ...
            localSearchIterator = localSearchIterator + 1
            if localSearchIterator == 5000: #depends the time 
    ...
    def ApplyRelocationMove(self, rm: RelocationMove):
        ...
        #oldCost = self.CalculateTotalCost(self.sol)  for debugging
        ...
        #newCost = self.CalculateTotalCost(self.sol)  for debugging
        # debuggingOnly
